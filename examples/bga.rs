...
async fn main() -> Result<()> {
    ...
    let attributes = client.beatmaps.get_beatmap_attributes(5000433,None,Some(Mode::Osu),None).await?;
    println!("{:?}", attributes);
...
// Attributes { attributes: DifficultyAttributes { max_combo: 0, star_rating: 6.40266 } }
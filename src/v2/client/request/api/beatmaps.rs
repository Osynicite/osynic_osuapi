...
impl IBeatmaps for ReqwestBeatmaps {
    ...
    async fn get_user_score(&self,beatmap_id:u32,user_id:u32,legacy_only:Option<u32>,mode:Option<Mode>,mods:Option<String>) -> Result<BeatmapUserScore> {
        ...
        .get(format!("https://osu.ppy.sh/api/v2/beatmaps/{}/scores/users/{}",beatmap_id,user_id))

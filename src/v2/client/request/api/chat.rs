...
impl IChat for ReqwestChat {
    ...
    async fn get_channel_messages(
        ...
        let res = self.client
            .get(format!("https://osu.ppy.sh/api/v2/chat/channels/{}/messages", channel))
            .header("Accept", "application/json")
            .header("Content-Type", "application/json")
            .header("Authorization", format!("Bearer {}", access_token))
            .query(&[
    ...
    async fn send_message_to_channel(
        ...
        let res = self.client
            .post(format!("https://osu.ppy.sh/api/v2/chat/channels/{}/messages", channel))
            .header("Accept", "application/json")
            .header("Content-Type", "application/json")
            .header("Authorization", format!("Bearer {}", access_token))
            .json(&serde_json::json!({
    ...
    async fn join_channel(
        ...
        let res = self.client
            .put(format!("https://osu.ppy.sh/api/v2/chat/channels/{}/users/{}", channel, user))
            .header("Accept", "application/json")
            .header("Content-Type", "application/json")
            .header("Authorization", format!("Bearer {}", access_token))
            .send().await?;
    ...
    async fn leave_channel(
        ...
        let res = self.client
            .delete(format!("https://osu.ppy.sh/api/v2/chat/channels/{}/users/{}", channel, user))
            .header("Accept", "application/json")
            .header("Content-Type", "application/json")
            .header("Authorization", format!("Bearer {}", access_token))
            .send().await?;
    ...
    async fn mark_channel_as_read(
        ...
        let res = self.client
            .put(format!("https://osu.ppy.sh/api/v2/chat/channels/{}/mark-as-read/{}", channel, message))
            .header("Accept", "application/json")
            .header("Content-Type", "application/json")
            .header("Authorization", format!("Bearer {}", access_token))
            .query(&[
    ...
    async fn get_channel(
        ...
        let res = self.client
            .get(format!("https://osu.ppy.sh/api/v2/chat/channels/{}", channel))
            .header("Accept", "application/json")
            .header("Content-Type", "application/json")
            .header("Authorization", format!("Bearer {}", access_token))
            .send().await?;

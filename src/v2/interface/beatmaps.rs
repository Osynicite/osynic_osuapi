...
pub trait IBeatmaps {
    ...
    fn get_solo_scores(&self,beatmap_id:u32,mode:Option<Mode>,mods:Option<String>,ranking_type:Option<String>) -> impl std::future::Future<Output = Result<BeatmapScores>> + Send;
